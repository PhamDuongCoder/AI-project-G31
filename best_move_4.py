"""best_move without killer move heuristic, move ordering and quiescence search"""
"""Compared to best_move_5, this bot has alpha_beta prunning, which makes it faster"""
import chess
import random
